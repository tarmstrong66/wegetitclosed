...
export const faqs = [
  {
    ...
    answer: "No. FHA and USDA loans don't require first-time buyer status. However, certain down payment assistance programs and state programs do restrict access to first-time buyers (defined as someone who hasn't owned a home in the past 3 years in some cases)."
  },
  {
    question: "How much do I need saved before buying my first home?",
    answer: "It depends on the loan program. FHA requires at least 3.5% down (plus closing costs). USDA and VA can be zero down (with closing costs). Conventional programs start at 3% down. Closing costs typically add 2-5% of the loan amount. Plan for both your down payment and closing costs when estimating how much you need."
  },
  {
    question: "What credit score do I need as a first-time homebuyer?",
    answer: "FHA allows scores as low as 580 with 3.5% down. Conventional programs typically require 620 or higher. VA and USDA have their own overlays. The higher your score, the more programs and better terms will be available to you."
  },
  {
    question: "How does a mortgage pre-approval work?",
    answer: "Pre-approval involves submitting your income, asset, and credit information to a lender for review. The lender evaluates your full financial profile and provides a pre-approval letter stating the loan amount you may be eligible for. It's not a final loan commitment, but it shows sellers that you're a serious, qualified buyer."
  },
  {
    question: "Are there down payment assistance programs for first-time buyers?",
    answer: "Many states offer down payment assistance programs for first-time buyers. Availability, income limits, and purchase price caps vary by state and program. Some programs provide grants; others provide forgivable or repayable second loans. Ask your loan officer about current programs in your state."
  },
  {
    question: "Can I use gift money for my down payment?",
    answer: "Yes, in most cases. FHA, VA, USDA, and many conventional programs allow the down payment to come fully or partially from a gift from a family member. Gift fund requirements vary by program (documentation, donor relationship). Talk with your loan officer about how gifts should be documented."
  }
];
